...
class ColorBalanceAnalyzer:
    ...
    # Main entry point
    # ----------------------------------------------------------------------
    def analyze(self, image, show_plots=True):
        ...
        if show_plots:
            ...
            self._plot_results(img, segments, filtered_clusters)
    ...
    # Plotting
    # ----------------------------------------------------------------------
    def _plot_results(self, img, segments, clusters, filepath="color_distribution.png"):
        logging.info(f"Saving plot to '{filepath}'...")
...
if __name__ == "__main__":
    ...
    result = analyzer.analyze("/Users/zhangxiaoxuan/Workplace/development/colorbalance/colorbalance_python/spacejoy_q3_Qd86sfao_U_unsplash_ee33419bee.jpg", show_plots=True)
    print(result)
