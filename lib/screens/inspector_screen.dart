...
class _InspectorScreenState extends State<InspectorScreen>
  ...
  Future<void> _selectColor(int index) async {
    // Toggle logic: if tapping the same index, deselect it.
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedIndex != null) {
      ...
      activeColor = Color.fromARGB(255, activeColorData.red,
          activeColorData.green, activeColorData.blue);
    }
...
class _FloatingHud extends StatelessWidget {
  ...
  const _FloatingHud(
      {required this.color, required this.hex, required this.percentage});
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return ClipRRect(
            ...
            children: [
              ...
              Row(
                ...
                children: colors.asMap().entries.map((entry) {
                  int i = entry.key;
                  return _Swatch(
                      color: Color.fromARGB(255, colors[i].red, colors[i].green,
                          colors[i].blue),
              ...
              Expanded(
                  child: ListView.separated(
                      ...
                      itemBuilder: (_, i) => _Swatch(
                          color: Color.fromARGB(255, colors[i].red,
                  ...
                  Row(
                      ...
                      children: [
                        Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("TECHNICAL SPECTRUM",
                                  style: theme.textTheme.labelSmall),
                              const SizedBox(height: 8),
                              Text(colorData.hex.toUpperCase(),
                                  style: theme.textTheme.displayLarge?.copyWith(
                                      fontSize: 32,
                                      color: theme.colorScheme.onSurface))
                            ]),
    ...
    return Padding(
      ...
      child: Row(
          ...
          children: [
            ...
            Text(value,
                style: TextStyle(
                    color: color, fontFamily: 'monospace', fontSize: 16))
          ]),
    );
  }
}